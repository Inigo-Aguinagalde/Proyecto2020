...
Future<Usuario> deleteRutaActiva(String id_user) async {
  var user;
  Usuario usuario;
  final String url =
      'http://10.10.12.133:8080/usuario/deleteRutaActiva?id_user=' + id_user;
  /*final String url =
      'http://192.168.1.119:8080/usuario/updateRutaActiva?id_user=' + id_user;*/
